...
## Replace file path with you own absolute path for an advising report
print(str(scrap_from_adv_rep("/home/kau/KnowledgeSysCapstone/coursesearchplus/adv_rep_scraper/test/OSR_ADVISING_NV.pdf")))
